  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="w-full py-3 mb-8 rounded-2xl border border-neutral-700 light:border-neutral-300 bg-neutral-900 flex items-center justify-between gap-4 px-4"
      >
        <div className="flex items-center gap-3 text-sm text-neutral-300">
          ...
          <span>
            ...
            free messages. Sign up to keep chatting.
          </span>
        </div>
