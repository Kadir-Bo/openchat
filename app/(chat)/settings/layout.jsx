  ...
  return (
    <div className={`h-[calc(100dvh-48px)] overflow-y-scroll px-4`}>
      <div className="max-w-220 mx-auto flex flex-col md:flex-row gap-6 items-start">
        {/* Sidebar Navigation */}
        <aside className="w-full md:w-48 fixed md:sticky left-0 md:top-16 z-99 shrink-0 px-5 py-2 md:py-0 md:px-0 bg-neutral-900 border-t md:border-none border-neutral-800 md:bg-transparent">
